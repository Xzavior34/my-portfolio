...
export default function About() {
  const paragraphs = [
    <>
      I’m <span className="text-blue-400 font-semibold">Philip Inem</span>, a passionate developer and designer dedicated to building meaningful digital products. 
      My journey began with curiosity for technology, which quickly grew into a full career blending creativity, problem-solving, and strategy.
    </>,
    <>
      My expertise lies in full-stack development, with strong foundations in UI/UX design and digital growth strategy. 
      I’ve collaborated with organizations such as <span className="text-yellow-400 font-medium">Regamos Foundation</span> and <span className="text-yellow-400 font-medium">Sara Foundation</span>, 
    ...
    >
      ...
      <div className="max-w-5xl mx-auto px-6 text-center md:text-left relative z-10">
        ...
        {paragraphs.map((para, i) => (
          ...
          >
            <p className="text-lg leading-relaxed text-gray-200">{para}</p>
          </motion.div>
        ))}
